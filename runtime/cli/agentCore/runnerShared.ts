...
export interface AgentCoreRunnerOptions<TArgs> {
...
export async function runInjectedOrDefault<TArgs>(
  options: AgentCoreRunnerOptions<TArgs>,
...
function validateRunnerOptions(options: unknown): asserts options is AgentCoreRunnerOptions<unknown> {
  if (typeof options !== "object" || options === null || Array.isArray(options)) {
    throw new Error("Agent Core runner options must be an object");
  }
}
