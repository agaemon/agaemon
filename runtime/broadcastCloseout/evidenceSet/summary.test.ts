...
describe("createAgentProposalExecutionBroadcastCloseoutEvidenceSetSummary", () => {
  it("renders deterministic Markdown for a verified final evidence set", () => {
    const summary = createAgentProposalExecutionBroadcastCloseoutEvidenceSetSummary(createEvidenceSet());
  ...
  it("returns verifier failures for stale status evidence", () => {
