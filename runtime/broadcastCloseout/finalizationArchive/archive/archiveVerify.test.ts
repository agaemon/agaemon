...
describe("verifyAgentProposalExecutionBroadcastCloseoutFinalizationArchive", () => {
  it("accepts a saved finalization archive that matches current evidence", () => {
  ...
  it("rejects a stale saved finalization archive hash", () => {
    const evidence = createFinalizationArchiveEvidence();
    const archive = createAgentProposalExecutionBroadcastCloseoutFinalizationArchive(evidence);
