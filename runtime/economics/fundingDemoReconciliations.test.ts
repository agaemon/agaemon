...
import { createFundingDemoPayoutReconciliations } from "./fundingDemoReconciliations.js";

describe("createFundingDemoPayoutReconciliations", () => {
  it("creates deterministic local paid reconciliation evidence for the funding demo", () => {
    expect(createFundingDemoPayoutReconciliations()).toEqual([
      {
        assignmentId: "1",
